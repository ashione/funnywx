...
if(!isset($_SESSION['user'])){
    ...
    $secret = "338c8594a69e82ff41ebeab8dc46e764";
    $code = $_GET["code"];
...
{
	$timeline.=formatTweet($row['msg'],$row['dt'],$row['title']);
}

// fetch the latest tweet
$lastweet = '';
list($lastTweet) = mysql_fetch_array(mysql_query("SELECT msg FROM reportTimeline WHERE userid=".$idrow['id']." ORDER BY id DESC LIMIT 1"));
...
<meta name="viewport" content="width=device-width,initial-scale=1.3 minimum-scale=1.0, maximum-scale=2.0; charset=utf-8">
