...
define('APP_ID', 'wxfbe9dce4e7ae6926');//改成自己的APPID
define('APP_SECRET', '36225b5d3a10b08c13d986d9fca7da71');//改成自己的APPSECRET
        ...
        if (!empty($postStr)){
                ...
                if($MsgType=='event'){
                    ...
                    if ($MsgEvent=='subscribe') {//订阅事件
                        ...
                        $resultStr = sprintf($textTpl, $this->fromUsername, $this->toUsername, $this->times);
                        echo $arr[] = $resultStr;
                        exit;
